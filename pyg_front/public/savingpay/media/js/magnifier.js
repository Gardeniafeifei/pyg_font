...
(function($, window, document, undefined) {
	...
	Magnifier.prototype = {
		...
		setMask: function() {
			var mask_w = "200px";
				/*this.$smallBox.width() / (this.$bigBox_pic.width() / this.$bigBox.width());*/
			var mask_h = "150px";
				/*this.$smallBox.height() / (this.$bigBox_pic.height() / this.$bigBox.height());*/
		...
		inital: function() {
			...
			this.$thumbnailBox_next.click(function() {
				var ov_pic = self.$thumbnailBox_item.length - 0;
